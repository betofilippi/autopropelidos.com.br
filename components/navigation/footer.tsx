    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          {/* Links Sections */}
          <div>
            <h3 className="text-white font-semibold mb-4">{footerLinks.platform.title}</h3>
          ...
          <div>
            <h3 className="text-white font-semibold mb-4">{footerLinks.tools.title}</h3>
            <ul className="space-y-2">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-400">contato@autopropelidos.com.br</span>
            </div>
            <div className="flex items-center space-x-3">
