              ...
              >
                <div className="relative">
                  ...
                  <div className="relative aspect-video bg-gray-200 dark:bg-gray-700 rounded-t-lg overflow-hidden">
                    ...
                    <img
                      src={video.thumbnail_url || 'https://placehold.co/480x360/e5e7eb/9ca3af?text=Video+Thumbnail'}
                      alt={video.title}
                      ...
                      onError={(e) => {
                        ...
                        e.currentTarget.src = 'https://placehold.co/480x360/e5e7eb/9ca3af?text=Video+Thumbnail'
